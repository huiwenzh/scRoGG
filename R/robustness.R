...
#' @param stats By default, performs asymptotic test for the equality of coefficients of variation to determine against null distribution.          If changes to FALSE, top one percent most stably correlated gene pairs will be returned.
